                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group align-content-center">
                                    <button  id="btnitemadd" type="button" class="btn btn-outline-primary col-2" >
                                        Add
                                    </button>
                                    <button id="btnitemDel" type="button" class="btn btn-outline-danger col-2">
                                        Delete
                                    </button>
                                    <button id="btnitemUpdate" type="button" class="btn btn-outline-success col-2">
                                        Update
                                    </button>
                                </div>
                            </div>
...
<script src="dist/controller/itemController.js"></script>
